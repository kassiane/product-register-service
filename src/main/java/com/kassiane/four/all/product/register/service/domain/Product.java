...
public class Product {
    ...
    public Product(final long id, final String name, final float price, final ImageIcon icon) {
    ...
    public boolean equals(final Object object) {
        if (object instanceof Product) {
            ...
            return Objects.equal(this.id, that.id) && Objects.equal(this.name, that.name)
                    && Objects.equal(this.price, that.price) && Objects.equal(this.icon, that.icon);
        }
        return false;
    }
